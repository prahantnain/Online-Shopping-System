...
const ManagerSignUp = () => {
    ...
    return (
        <div>
            <h2 className="title">Manager Registration</h2>
            ...
            <div className="row">
                ...
                <div className="col">
                    <div className="form">
                        ...
                        <div className="mb-3">
                            <div>
                                Already have an account? <Link to="/manager/signin">Login here!</Link>
                            </div>
                            <button className="btn btn-primary" onClick={signUpManager}>Register</button>
                        </div>
                    </div>
                </div>
                <div className="col"></div>
