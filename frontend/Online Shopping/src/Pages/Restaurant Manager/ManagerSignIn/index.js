        ...
        if(email.length === 0)
            ...
            axios.post(url, body).then((response) => {
                ...
                if(result.status === "SUCCESS") {
                    toast.success("Welcome to OnlineShopping")
            ...
            <div className="row">
                ...
                <div className="col">
                    <div className="form">
                        ...
                        <div className="mb-3">
                        <div>
                                No account? <Link to="/manager/signup">Register here!</Link>
                            </div>
                           <button className="btn btn-primary" onClick={signInManager}>Login</button>
                        </div>
                    </div>
                </div>
                <div className="col"></div>
