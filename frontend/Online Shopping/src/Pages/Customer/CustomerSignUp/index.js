                ...
                <div className="col">
                    <div className="form">
                        ...
                        <div className="mb-3">
                            ...
                            <textarea onChange={ (e) => setAddress(e.target.value) } value={address}  className="form-control" id="address"> </textarea>
                        </div>
                        ...
                        <div className="mb-3">
                            <div>
                                Already have an account? <Link to="/customer/signin">Login here!</Link>
                            </div>
                            <button className="btn btn-primary" onClick={signUpCustomer}>Register</button>
                        </div>
                    </div>
                </div>
                <div className="col"></div>
