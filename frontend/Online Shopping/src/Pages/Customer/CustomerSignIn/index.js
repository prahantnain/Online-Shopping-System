        ...
        if(email.length === 0)
            ...
            axios.post(url, body).then((response) => {
                ...
                if(result.status === "SUCCESS") {
                    toast.success("Welcome to Online Shopping")
            ...
            <div className="row">
                ...
                <div className="col">
                    <div className="form">
                        ...
                        <div className="mb-3">
                            <div>
                                No account? <Link to="/customer/signup">Register here!</Link>
                            </div>
                            <button className="btn btn-primary" onClick={signInCustomer}>Login</button>
                        </div>
                    </div>
                </div>
                <div className="col"></div>
